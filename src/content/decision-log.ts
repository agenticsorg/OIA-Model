/**
 * OIA Model v0.1 Decision Log Digest — verbatim content, structured
 * for rendering by the DecisionLog component. Every rationale and
 * revisit trigger is reproduced from
 * docs/OIA-Model-v0.1-Decision-Log-Digest.md without editorial change.
 */

import type { Decision } from './types';

export const decisionLogMeta = {
  publisher: 'AGENTICS FOUNDATION',
  title: 'Decision Log Digest',
  tagline: "Companion to the Reader's Digest · 2026",
  heading: 'The Eleven Decisions Most Worth Weighing In On',
};

export const decisionLogPurpose = {
  heading: 'Purpose',
  paragraphs: [
...
export const decisions: Decision[] = [
  {
    ...
    id: 'decision-01',
    category: 'Naming',
    title: 'The model is called the OIA Model — Open Intelligence Architecture.',
    rationale:
    ...
    revisitTrigger:
      'Strong evidence that Open Intelligence Architecture has an existing specific usage in a related domain that would create confusion.',
  },
  {
    number: '02',
    id: 'decision-02',
    category: 'Naming',
    title: 'Layer 8 is called the Continuity Fabric.',
    rationale:
    ...
    revisitTrigger:
      'A better name that preserves both the active-layer quality and the continuity-through-change function. Fabric is the weakest component of the name if any word is.',
  },
  {
    number: '03',
    id: 'decision-03',
    category: 'Naming',
    title: 'The asymmetry between Layers 3 and 8 is an architectural feature, not an awkwardness.',
    rationale:
  ...
  },
  {
    ...
    id: 'decision-04',
    category: 'Structure',
    title: 'Nine layers, not seven or twelve.',
    rationale:
  ...
  },
  {
    ...
    id: 'decision-05',
    category: 'Structure',
    title: 'State-holding layers bracket the operational layers.',
    rationale:
  ...
  },
  {
    ...
    id: 'decision-06',
    category: 'Structure',
    title: 'Cross-layer concerns are a separate section, not distributed into each layer.',
    rationale:
  ...
  },
  {
    ...
    id: 'decision-07',
    category: 'Structure',
    title: 'Each layer ends with Open Questions.',
    rationale:
  ...
  },
  {
    ...
    title: 'Institutional third-person voice throughout, with the Foreword as the one exception.',
    rationale:
  ...
  },
  {
    ...
    id: 'decision-09',
    category: 'Editorial Voice',
    title: 'No Cognitum, Snapper, or ACIUM branding in the body of the document.',
    rationale:
  ...
  },
  {
    ...
    id: 'decision-10',
    category: 'Editorial Voice',
    title: 'The document is correctly opinionated where evidence supports it.',
    rationale:
  ...
  },
  {
    number: '11',
    id: 'decision-11',
    category: 'Explicit Deferrals',
    title: 'Four things are deliberately deferred to future work.',
    rationale:
      'The first draft is intentionally incomplete in four specific places, and the incompleteness is principled rather than expedient. These deferrals are not evidence of an unfinished first draft. They are evidence that the draft has a clear sense of what belongs in a first version and what belongs in subsequent ones. Reviewers are encouraged to flag any additional work they believe should be deferred — or, conversely, to argue that something currently deferred should have been included.',
    subItems: [
      {
        title: 'The maturity model',
        body: 'How organisations progress through adopting the architecture — is a separate document with different intellectual foundations (the Christensen and Moore disruption-theory lineage, the CMMI tradition, adoption-curve frameworks). Conflating a reference architecture with a maturity model would weaken both.',
      },
      {
        title: 'The architectural diagram',
        body: 'Described at Section 3 but not yet produced, and will appear in the illustrated edition after the first round of review.',
      },
      {
        title: 'The Appendix acknowledging contributors',
        body: 'Will be completed after community review closes.',
      },
      {
        title: 'Verified References entries',
        body: 'Several References entries are flagged as requiring verification against current published sources before any formal publication.',
      },
    ],
  },
];

export const usingThisLog = {
  heading: 'On Using This Log',
  paragraphs: [
...
export const decisionCategoryOrder = [
  'Naming',
  'Structure',
  'Editorial Voice',
  'Explicit Deferrals',
...
export const decisionCategoryRoman: Record<string, string> = {
  Naming: 'I. Naming',
  Structure: 'II. Structure',
  'Editorial Voice': 'III. Editorial Voice',
  'Explicit Deferrals': 'IV. Explicit Deferrals',
};
